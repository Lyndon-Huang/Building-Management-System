...
public class ViewModel {
    ...
    public void accept(KeyCode keyCode) {
        if (keyCode == KeyCode.getKeyCode("P") || keyCode == KeyCode.getKeyCode("p")) {
            togglePause();
        } else if (keyCode == KeyCode.getKeyCode("Q") || keyCode == KeyCode.getKeyCode("q")) {
            System.exit(0);
        } else if (keyCode == KeyCode.getKeyCode("S") || keyCode == KeyCode.getKeyCode("s")) {
            try {
    ...
    public void togglePause() {
        ...
        if (this.pauseButtonText.get().equals("Unpause")) {
            this.pauseButtonText.setValue("pause");
        } else {
            this.pauseButtonText.setValue("Unpause");
        }
    }
    ...
    public void tick() {
        if (!paused.getValue()) {
            ...
            this.ticks.setValue(ticks.get() + 1);
