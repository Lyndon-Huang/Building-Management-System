...
public class NoiseSensor extends TimedSensor
     ...
     * https://www.iacacoustics.com/blog-full/comparative-examples-
     * of-noise-levels.html
    ...
    public int getHazardLevel() {
        double relativeLoudnessMult100 =
                this.calculateRelativeLoudness() * 100;
     ...
     * calculateRelativeLoudness() from 1, multiplies the result by 100
     * (floating point multiplication should be used), then rounds down
     * to the largest integer that is less than or equal
    ...
    public int getComfortLevel() {
        double comfortLevel;
        comfortLevel = Math.floor(1 - this.calculateRelativeLoudness() * 100);
        if (comfortLevel < 0) {
            return 0;
        } else {
     ...
     * and 'frequency' is this sensor's update frequency (in minutes).
    ...
    public String encode() {
        return (String.format("NoiseSensor:%s:%d",
                super.encode(), this.getUpdateFrequency()));
    }
